...
import { SearchIcon, BellIcon, SunIcon, MoonIcon, InformationCircleIcon } from './IconComponents';
    ...
    <>
      <header className="flex items-center justify-between h-20 px-6 bg-base-100 border-b border-base-300 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex items-center space-x-4">
          <button onClick={() => setIsInfoOpen(true)} className="p-2 rounded-full hover:bg-base-200 dark:hover:bg-gray-700" title="System Info & SQL">
              <InformationCircleIcon className="w-6 h-6 text-gray-500 dark:text-gray-400" />
          </button>
      ...
      <SqlInfoModal isOpen={isInfoOpen} onClose={() => setIsInfoOpen(false)} />
    </>
  );
};
