...
const FinancialSummaryCard: React.FC<FinancialSummaryCardProps> = ({ title, amount, color, bgColor }) => {
  ...
  return (
    <div className="bg-base-100 p-6 rounded-2xl shadow-sm flex items-center justify-between transition-all transform hover:scale-[1.02] dark:bg-[#111111] border border-base-300 dark:border-white/10">
      <div>
