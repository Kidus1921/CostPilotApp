...
const MainLayout: React.FC = () => {
    const { currentUser, authChecked, isProcessingAuth, error, isOnline, refreshData, setActivePage: setContextPage, backendStatus, theme, toggleTheme } = useAppContext();
    ...
    return (
        <div className="flex h-screen bg-base-200 text-base-content font-sans dark:bg-[#0b0b0b] dark:text-gray-200 overflow-hidden theme-transition">
            <Sidebar 
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto p-2 sm:p-4 bg-base-200 dark:bg-[#0b0b0b] pb-24 md:pb-4 theme-transition">
